...
<html  dir="rtl" lang="ar"  xml:lang="ar">
    ...
    <body style="direction: rtl;">
      ...
      <td><a href="modifier_grade_emp.php?ID_GRADE= ' . $row['ID_GRADE'] . '" > تحديث </a></td>
     
     <td><a href="function_supprimer_grade.php?ID_GRADE=' . $row['ID_GRADE'] . '" onclick="return(confirm(\'Etes-vous sur de vouloir supprimer ce grade?\'));" >حذف</a></td>
     </tr>';
                                        $nem = $nem + 1;
                                    }
                                    ?>
