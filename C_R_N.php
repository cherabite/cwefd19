...
:</span> حول إثبات صحة كشف النقاط . &nbsp;  <br>
      <br>
&nbsp;&nbsp;&nbsp; <span
...
أعلاه ، يشرفني أن أعلمكم بأن كشف النقاط المقدم من طرف </p>
&nbsp;&nbsp;
...
&nbsp; &nbsp;&nbsp; &nbsp; ب :&nbsp; &nbsp;<?php echo $LNS; ?><br>
      <br>
&nbsp; &nbsp;&nbsp; &nbsp;الحامــل(ة) &nbsp;لرقــم التسجيل :&nbsp;<?php echo $MATR ; ?>&nbsp;/&nbsp;<?php echo $ORDREC ; ?>
                          &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                          &nbsp; &nbsp;<br> <br>
                          &nbsp;&nbsp;&nbsp;&nbsp; خلال السنــة الدراسيـــة :&nbsp;<?php echo $IANNEE; ?><br><br>
						   &nbsp;&nbsp;&nbsp;&nbsp; المستوى الدراسي  :&nbsp;<?php echo $FILIERE; ?><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;و التي تنص على أن
المعني (ة) قد تحصل (ة) على النقاط المدونة في الكشف 
 <br>
      <br>
      <br>
