    ...
    <div>
        ...
        <hr color="blue" width="75%">
            ...
            if (isset($_POST['valider'])) {
                ...
                if ($NUM_BUR == 'DESTRUCTION') {
          
                    $select = "SELECT * FROM inventaire WHERE ETAT_INV = 'DESTRUCTION' ORDER BY NUM_INV  ASC ";
                    ...
                    if ($total) {
                        ...
                        <h3><u>LISTE D'INVENTAIRES DESTRUCTION</u> </h3>
                        <hr>
		...
		&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
                ...
                &nbsp;مديرة المركز الولائـــي					
                               <?php   
                                ...
                                $DESTRU = 'table_inv_des';
                                $select = "SELECT * FROM deteruire_inv   ORDER BY ID_INV  ASC ";
                                $result = mysql_query($select);
                                $total = mysql_num_rows($result);
                                if ($total) {
                                    ?>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><select name="NUM_BUR"> 
                                                 ...
                                                 <option selected> DESTRUCTION </option>
												  <option selected> table_inv_des </option>
                                                    </select></td>
                                            </tr>
