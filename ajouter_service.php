                    ...
                    <td>
                        ...
                        if (isset($_POST['SERVICE'])) {
                            ...
                            if ($_POST['SERVICE'] != "") {
                                ...
                                $nbr = mysql_fetch_array(mysql_query("select count(*) as nb from tab_services where NOM_SERVICE='$SERVICE' "));
                                if ($nbr['nb'] > 0) {
                                    ?> <SCRIPT LANGUAGE="Javascript">	alert("erreur! موجود");</SCRIPT> <?php
                                } else {

                                    $sql_inser = "INSERT  INTO tab_services (NOM_SERVICE)
                                   VALUES ('$SERVICE') ";
