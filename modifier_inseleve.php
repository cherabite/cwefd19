...
mysql_query("update inscription set ORDREC='$ORDREC'
 where  inscription.IANNEEINS='$IANNEEINS' and inscription.INSEQ='$INSEQ' and inscription.IANNEE='$IANNEE0'  and inscription.ICODE='$ICODE0' ");
