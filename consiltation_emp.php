    ...
    if ($PRESUME == '0') {
        ?><option value="<?php echo 'لا'; ?>"><?php echo 'لا'; ?></option>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3" rowspan="1"><input
                                                        name="N_CCP" value="<?php echo $line['N_CCP']; ?>" type="number"></td>

                                            </tr>
                                            <tr>
                                                <td>رقم الضمان الإجتماعي </td>
                                                <td colspan="3" rowspan="1"><input
                                                        name="N_ASSURENCE" value="<?php echo $line['N_ASSURENCE']; ?>" type="number"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>رقم الهاتف </td>
                                                <td><input
                                                        name="TEL" value=" <?php echo $line['TEL']; ?>" type="number"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </fieldset>
