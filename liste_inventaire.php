...
<h4 style="text-align: right;"><u> ملاحظة :</u> يتحمل الموظف الموقع أسفله مسؤولية الجرد المتواجد بمكتبه و المسجل على ورقة الجرد</h4>
            <?php
            ...
            if (isset($_POST['valider'])) {
                ...
                if ($NUM_BUR == 'TOUTE L INVENTAIRES') {
                    $DESTRU = 'DESTRUCTION';
                    $select = "SELECT * FROM inventaire  where ETAT_INV !='$DESTRU' and NUM_INV !=''  ORDER BY NUM_INV  ASC ";
		...
		&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
                ...
                &nbsp;مديرة المركز الولائـــي					
                               <?php   
                                ...
                                $DESTRU = 'DESTRUCTION';
                                $select = "SELECT * FROM inventaire  where   NUM_BUR ='$NUM_BUR' and NUM_INV !=''  ORDER BY NUM_INV  ASC ";
                                $result = mysql_query($select);
                                $total = mysql_num_rows($result);
                                if ($total) {
                                    ?>
