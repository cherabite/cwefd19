...
<html  dir="ltr" >
    ...
    <body style="direction: ">
      ...
      <td>' . $row['Cod_categorie'] . '</td>
      <td><a href="modif_categorie.php?ID_CATEGORIE= ' . $row['ID_CATEGORIE'] . '" > Modif </a></td>
     
	   <td><a href="function_supprimer_categorie.php? ID_CATEGORIE=' . $row['ID_CATEGORIE'] . '" onclick="return(confirm(\'Etes-vous sur de vouloir supprimer ce categorie?\'));" >Supp</a></td>
